<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('admin.analytics.partials.analytics_header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

    <div class="row">
        <div class="col-sm-12">
            <?php echo $__env->make('admin.analytics.partials.visitors_views', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-5">
            <?php echo $__env->make('admin.analytics.partials.visited_pages', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>

        <div class="col-md-7">
            <?php echo $__env->make('admin.analytics.partials.locations', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
    </div>
