                        ...
                        <table class="dt-table">
                            ...
                            <tr>
                                ...
                                <td style="min-width: 55px;">
                                    <form id="form-delete-row<?php echo e($photo->id); ?>" method="POST" action="/admin/photos/<?php echo e($photo->id); ?>" class="dt-titan">
        ...
        <div class="box box-primary box-solid">
            ...
            <div class="box-body">
                ...
                <form id="formPhotoDropzone" class="dropzone" method="POST" action="/admin/photos/upload" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="photoable_id" value="<?php echo e($photoable->id); ?>">
                    <input type="hidden" name="photoable_type" value="<?php echo e(get_class($photoable)); ?>">
                    <input type="hidden" name="photoable_type_name" value="<?php echo e((new \ReflectionClass($photoable))->getShortName()); ?>">
