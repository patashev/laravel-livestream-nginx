            ...
            <div class="box box-primary box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        ...
                        <span><?php echo e(isset($item)? 'Edit the ' . $item->title . ' entry': 'Create a new Province'); ?></span>
                    </h3>
                </div>
                    ...
                    <form method="POST" action="<?php echo e($selectedNavigation->url . (isset($item)? "/{$item->id}" : '')); ?>" accept-charset="UTF-8">
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group <?php echo e(form_error_class('country_id', $errors)); ?>">
                                    	<label for="country">Country</label>
                                    	<?php echo form_select('country_id', ([0 => 'Please select a Country'] + $countries), ($errors && $errors->any()? old('country_id') : (isset($item)? $item->country_id : '')), ['class' => 'select2 form-control']); ?>

                                    	<?php echo form_error_message('country_id', $errors); ?>
