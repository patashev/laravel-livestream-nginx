<div class="box box-primary box-solid">
  <div class="box-header with-border">
    <h3 class="box-title">
      ...
      <span><?php echo $photoable->name; ?> Снимки</span>
    </h3>
  </div>
  <div class="box-body">
    <?php $__empty_1 = true; $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="col box" style="max-width: 240px; margin:5px;">
          <div class="box-header">
            ...
            <a id="image-row-clicker-<?php echo e($photo->id); ?>" class="dropzone-image-click float-lg-right" href="#" data-id="<?php echo e($photo->id); ?>" data-title="<?php echo e($photo->name); ?>">
              <span style="float: right" id="image-row-title-span-<?php echo e($photo->id); ?>"><?php echo e(substr_replace($photo->name, '', 10, -1)); ?></span>
            </a>
          </div>
          ...
          <div class="box-body">
            <a href="<?php echo e($photo->url); ?>" data-lightbox="images" data-title="<?php echo e($photo->name); ?>">
              <img src="<?php echo e($photo->thumb_url); ?>" title="<?php echo e($photo->name); ?>" class="img img-thumbnail">
            </a>
          </div>
          <div class="box-footer">
            <div style="float: right;">
              
              <a href="<?php echo e(request()->url()); ?>/crop/<?php echo e($photo->id); ?>" class="btn btn-info" data-toggle="tooltip" title="<?php echo e($photo->name); ?>">
