        ...
        <div class="box box-primary box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">
                    ...
                    <span><?php echo $photoable->name; ?> Photos</span>
                </h3>
            </div>
            ...
            <div class="box-body superbox">
                <?php $__empty_1 = true; $__currentLoopData = $photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="superbox-list">
                            ...
                            <tr>
                                <td>
                                    <label class="radio" style="margin-top: -10px;;">
                                        <input class="photo-cover-radio" data-id="<?php echo e($photo->id); ?>" type="radio" name="is_cover" <?php echo $photo->is_cover == 1? 'checked' : ''; ?>>
                                        <i></i>
                                    </label>
                                </td>
                                <td style="object-fit: cover; display: block; margin: 15px; word-break: break-all; padding-bottom: 15px;">
                                    <a id="image-row-clicker-<?php echo e($photo->id); ?>" class="dropzone-image-click" href="#" data-id="<?php echo e($photo->id); ?>" data-title="<?php echo e($photo->name); ?>">
                                        <span id="image-row-title-span-<?php echo e($photo->id); ?>" class="image-row-title-span"><?php echo e($photo->name); ?></span>
                                    </a>
                                    <div class="fitt">
                                    <form id="form-delete-row<?php echo e($photo->id); ?>" method="POST" action="/admin/video-records/video-record-images/<?php echo e($photo->id); ?>" class="dt-titan">
                                        <input name="_method" type="hidden" value="DELETE">
                                        <input name="_token" type="hidden" value="<?php echo e(csrf_token()); ?>">
                                        <input name="_id" type="hidden" value="<?php echo e($photo->id); ?>">
                                        <input name="_video_id" type="hidden" value="<?php echo e($photoable->id); ?>">

                                        <a data-form="form-delete-row<?php echo e($photo->id); ?>" class="btn btn-danger btn-xs btn-delete-row" data-toggle="tooltip" title="Delete photo - <?php echo e($photo->name); ?>"
                                           style="float:right; padding: 0px 6px;">
                                            <i class="fa fa-times"></i>
                                        </a>
                                    </form>
                                    <a href="<?php echo e(request()->url()); ?>/crop/<?php echo e($photo->id); ?>" class="btn btn-info btn-xs" data-toggle="tooltip" title="Crop <?php echo e($photo->name); ?>"
                        ...
                        <a href="<?php echo e($photo->url); ?>" data-lightbox="images" data-title="<?php echo e($photo->name); ?>">
                            <img src="<?php echo e($photo->thumb_url); ?>" title="<?php echo e($photo->name); ?>" class="superbox-img">
                        </a>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <p class="text-muted">Please click on the panel below to upload photos
                        to <?php echo $photoable->name; ?>.
                    </p>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="col-sm-12">
        <div class="box box-primary box-solid">
            ...
            <div class="box-body">
                ...
                <form id="formPhotoDropzone" class="dropzone" method="POST" action="/admin/video-records/video-record-images/upload" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                    <input type="hidden" name="video_record_id" value="<?php echo e($photoable->id); ?>">
                    <input type="hidden" name="video_record_type" value="<?php echo e(get_class($photoable)); ?>">
                    <input type="hidden" name="video_record_type_name" value="<?php echo e((new \ReflectionClass($photoable))->getShortName()); ?>">
        ...
        $(function () {
            ...
            $('.photo-cover-radio').change(function () {
                ...
                $.ajax({
                    ...
                    data: {
                        photoable_id: "<?php echo e($photoable->id); ?>",
                        photo_id: id,
                        photoable_type: "<?php echo e(str_replace('\\','\\\\',get_class($photoable))); ?>",
                        photoable_type_name: "<?php echo e((new \ReflectionClass($photoable))->getShortName()); ?>",
                    },
                    dataType: "json",
