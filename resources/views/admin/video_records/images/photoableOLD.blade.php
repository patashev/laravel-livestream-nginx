        ...
        <div class="box box-primary box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">
                    ...
                    <span>{!! $videos->name !!} Photos</span>
                </h3>
            </div>


            <div class="box-body superbox">
                @forelse($photoable as $photo)
                        ...
                        <table class="dt-table">
                            ...
                            <tr>
                                ...
                                <td style="min-width: 55px;">
                                    <form id="form-delete-row{{ $photo->id }}" method="POST" action="/admin/video-records/video-record-images/{{ $photo->id }}" class="dt-titan">
    ...
    <div class="col-xs-12">
        <div class="box box-primary box-solid">
            ...
            <div class="box-body">
                ...
                <form id="formPhotoDropzone" class="dropzone" method="POST" action="/admin/video-records/video-record-images/upload/{{ $videos->id }}" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <input type="hidden" name="videorecordableimage_id" value="{{ $videos->id }}">
                    <input type="hidden" name="videorecordableimage_type" value="{{ get_class($videos) }}">
                    <input type="hidden" name="videorecordableimage_type_name" value="{{ (new \ReflectionClass($videos))->getShortName() }}">
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        $(function () {
            ...
            $('.photo-cover-radio').change(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: "/admin/video-records/videos/" + id + '/cover',
                    data: {
            ...
            $('#btn-form-save').click(function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "/admin/video-records/videos/" + $('#modal-photo-id').val() + '/edit/name',
                    data: {
