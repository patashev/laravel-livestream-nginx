        ...
        <div class="box box-primary box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">
                    ...
                    <span>{!! $videorecordableimage->name !!} Photos</span>
                </h3>
            </div>

            <div class="box-body superbox">
                @forelse($video_records as $photo)
        ...
        <div class="box box-primary box-solid">
            ...
            <div class="box-body">
                ...
                <form id="formPhotoDropzone" class="dropzone" method="POST" action="/admin/photos/upload" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="photoable_id" value="{{ $videoable->id }}">
                    <input type="hidden" name="photoable_type" value="{{ get_class($videoable) }}">
                    <input type="hidden" name="photoable_type_name" value="{{ (new \ReflectionClass($videoable))->getShortName() }}">
        ...
        $(function () {
            ...
            $('.photo-cover-radio').change(function () {
                ...
                $.ajax({
                    ...
                    data: {
                        photoable_id: "{{ $videoable->id }}",
                        photoable_type: "{{ str_replace('\\','\\\\',get_class($videoable)) }}",
                        photoable_type_name: "{{ (new \ReflectionClass($videoable))->getShortName() }}",
                    },
                    dataType: "json",
