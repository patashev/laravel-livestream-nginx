                            ...
                            <div class="row">
                              ...
                              <div class="col col-md-12">
                                <div class="form-group {{ form_error_class('sidebars_id', $errors) }}">
                                    ...
                                    {!! form_select('sidebars_id', ([0 => 'Please select a Sidebar'] + $moduls), isset($item)? ($errors && $errors->any()? old('sidebars_id') : $item->sidebars_id) : old('sidebars_id'), ['class' => 'select2 form-control ']) !!}
                                    {!! form_error_message('sidebars_id', $errors) !!}
                                </div>
                              </div>
