        ...
        <div class="box box-primary box-solid">
            ...
            <div class="box-body">
                ...
                <form id="formPhotoDropzone" class="dropzone" method="POST" action="/admin/photos/upload" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="photoable_id" value="{{ $item->id }}">
                    <input type="hidden" name="photoable_type" value="{{ get_class($item) }}">
                    <input type="hidden" name="photoable_type_name" value="{{ (new \ReflectionClass($item))->getShortName() }}">
