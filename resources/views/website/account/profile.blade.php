    ...
    <section class="content p-3">
        ...
        <div class="row">
            <div class="body col-sm-7 col-lg-8">
                ...
                <h2>@lang('profile.update_my_information')</h2>
                    ...
                    <div class="col-md-12">
                        <form id="form-member-register" method="POST" action="{{ request()->url() }}" accept-charset="UTF-8">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group {{ form_error_class('firstname', $errors) }}">
                                        <label>@lang('profile.firstname')</label>
                            ...
                            <div class="form-group {{ form_error_class('cellphone', $errors) }}">
                              <label>@lang('profile.cellphone')</label>
                            ...
                            <div class="form-group {{ form_error_class('password_confirmation', $errors) }}">
                              <label>@lang('profile.confirm_password')</label>
                                <div class="input-group">
                                    <input type="password" class="form-control" id="id-password_confirmation" name="password_confirmation" placeholder="@lang('profile.enter_confirm_password')" value="{{ old('password_confirmation') }}">
                                    <div class="input-group-append"><span class="input-group-text"><i class="fa fa-lock"></i></span></div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12 text-right">
                                    <button type="submit" class="btn btn-primary btn-submit">
                                        <label>@lang('profile.update')</label>
                                    </button>
                                </div>
                            </div>
                        </form>
