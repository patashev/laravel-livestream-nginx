...
@section('content')
    <div class="row mt-4 body">
        <div class="col-lg-6 offset-lg-3 col-md-6 offset-md-3 col-sm-8 col-sm-offset-2">
            ...
            <h2 class="page-header text-center mb-4">Вход</h2>
            ...
            <form action="/auth/login" accept-charset="UTF-8" method="POST">
                ...
                <div class="form-group {{ form_error_class('email', $errors) }}">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="id-email" name="email" placeholder="Email адрес" value="{{ old('email') }}">
                ...
                <div class="form-group {{ form_error_class('password', $errors) }}">
                    ...
                    <div class="input-group">
                        <input type="password" class="form-control" id="id-password" name="password" placeholder="Парола" value="{{ old('password') }}">
                ...
                <div class="row">
                    <div class="col-8">
                        <a class="btn btn-link padding-left-0" href="{{ route('forgot-password') }}">Забравена парола?</a>
                    </div>
