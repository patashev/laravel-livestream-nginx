...
use App\Models\ModuleSettingsList;
...
class SettingsController extends AdminController
{
	 ...
	 *
	 * @param Settings $setting
	 * @param ModuleSettingsList $moduleSettingsList
   * @return Response
  */
    public function edit(Settings $setting, ModuleSettingsList $moduleSettingsList)
	{
		$moduleSettingsList = $moduleSettingsList->getAllList();
		return $this->view('settings.settings.create_edit')->with([
			'item' => $setting,
