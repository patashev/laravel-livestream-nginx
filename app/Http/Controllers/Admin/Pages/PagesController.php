...
class PagesController extends AdminController
{
    ...
    public function index()
    {
        ...
        return $this->view('pages.index')->with([
          'items' => $items
        ]);
    }
    ...
    {
        $sidebar = Page::find($page->id)->pageSidebars()->get();
        $parents = Page::getAllList();
        $banners = Banner::getAllList();
        //$moduls = Page::find($page->id)->sidebars;
        $moduls = Sidebars::getAllList();

        return $this->view('pages.create_edit', compact('parents', 'banners', 'moduls', 'sidebar'))
          ->with(['item' => $page]);
    }
    ...
    public function update(Page $page)
    {
        ...
        $attributes['sidebars_id'] = input('sidebars_id');
