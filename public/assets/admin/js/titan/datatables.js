...
function initDatatablesAjaxVideo(selector, url, massDelete, addToPlayList, displayLength, options)
{
    ...
    options.aLengthMenu = [[displayLength, 25, 50, -1], [displayLength, 25, 50, "All"]];
