/* functions abouth admin modal with video */
function loadVideoJsModal( modalWindowid ){
    $( modalWindowid ).on('show.bs.modal', function (event) {
      ...
      video.classList.add('video-js', 'vjs-sublime-skin', 'vjs-big-play-centered');
...
function getPlaylistOptions(sel){
